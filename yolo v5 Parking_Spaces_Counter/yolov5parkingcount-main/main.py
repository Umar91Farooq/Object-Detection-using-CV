...
area_1=[(24,433),(9,516),(409,490),(786,419),(720,368)]
#area_2=[(806,354),(857,393),(998,351),(960,306),(791,332)]
count=0
...
while True:
    ...
    #cv2.polylines(frame,[np.array(area_2,np.int32)],True,(0,255,0),2)
    a=(12-len(list))
    cv2.putText(frame,"Parking Slots Available: "+str(a),(50,124),cv2.FONT_HERSHEY_PLAIN,4,(0,0,255),3)
